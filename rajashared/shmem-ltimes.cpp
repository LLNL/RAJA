                          ...
                          Index_type num_zones)
{
  ...
  using Pol = RAJA::nested::Policy<
      RAJA::nested::CudaCollapse<
        ...
        RAJA::nested::TypedFor<2, RAJA::cuda_block_y_exec, IGroup>,
        RAJA::nested::TypedFor<3, RAJA::cuda_threadblock_x_exec<512>, IZone> >,
      RAJA::nested::TypedFor<1, RAJA::cuda_loop_exec, IDirection>
      >;
...
//  int GZ_chunk = 12;
  ...
  using LaunchPolicy =
      nested::Policy<nested::CudaCollapse<
        nested::For<0, cuda_block_x_exec>,
        nested::For<1, cuda_thread_x_exec>>>;
