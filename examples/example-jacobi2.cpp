  ...
  */
  ...
  while (resI2 > tol * tol) {
    ...
    /*
      Jacobi Iteration
    */
    //Q: How to shorten this? How to create a parallel region?
    RAJA::nested::forall(camp::make_tuple(RAJA::nested::For<0, RAJA::omp_for_nowait_exec>{},
                                          RAJA::nested::For<1, RAJA::omp_for_nowait_exec>{}),
                         camp::make_tuple(jacobiRange,jacobiRange),
                         [=] ( RAJA::Index_type n, RAJA::Index_type m) {
  ...
  while (resI2 > tol * tol) {
    ...
    */
    RAJA::nested::forall(camp::make_tuple(RAJA::nested::Collapse< 
                                          ...
                                          RAJA::nested::For<0, RAJA::cuda_exec<CUDA_BLOCK_DIM_X>>,
                                          RAJA::nested::For<1, RAJA::cuda_exec<CUDA_BLOCK_DIM_Y>>>{}),
                         camp::make_tuple(jacobiRange, jacobiRange),
                         [=] RAJA_HOST_DEVICE (RAJA::Index_type m, RAJA::Index_type n) {            
