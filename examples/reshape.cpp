...
//
  ...
  auto Aview = RAJA::Reshape<RAJA::layout_right>::get(A, N, N_r, N_c);
  auto Bview = RAJA::Reshape<RAJA::layout_right>::get(B, N, N_r, N_c);
  auto Cview = RAJA::Reshape<RAJA::layout_right>::get(C, N, N_r, N_c);
...
//
  ...
  auto Aview2 = RAJA::Reshape<RAJA::layout_left>::get(A2, N, N_r, N_c);
  auto Bview2 = RAJA::Reshape<RAJA::layout_left>::get(B2, N, N_r, N_c);
  auto Cview2 = RAJA::Reshape<RAJA::layout_left>::get(C2, N, N_r, N_c);
#endif
...
//
  ...
  std::cout<<"pop complete"<<std::endl;
