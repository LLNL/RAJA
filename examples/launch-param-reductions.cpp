...
//----------------------------------------------------------------------------//
  ...
  RAJA::launch<LAUNCH_POL1>
    ...
    RAJA::expt::Name("SeqReductionKernel"),
...
//----------------------------------------------------------------------------//
  ...
  RAJA::launch<LAUNCH_POL2>
    ...
    RAJA::expt::Name("OmpReductionKernel"),
     [=] RAJA_HOST_DEVICE (RAJA::LaunchContext ctx,
...
//----------------------------------------------------------------------------//
  ...
  RAJA::launch<LAUNCH_POL3>
    ...
    RAJA::expt::Name( "CUDAReductionKernel"),
     [=] RAJA_HOST_DEVICE (RAJA::LaunchContext ctx,
...
//----------------------------------------------------------------------------//
  ...
  RAJA::launch<LAUNCH_POL3>
    ...
    RAJA::expt::Name( "HipReductionKernel"),
     [=] RAJA_HOST_DEVICE (RAJA::LaunchContext ctx,
...
//----------------------------------------------------------------------------//
  ...
  RAJA::launch<LAUNCH_POL4>
    ...
    RAJA::expt::Name( "SyclReductionKernel"),
    [=] RAJA_HOST_DEVICE (RAJA::LaunchContext ctx,
