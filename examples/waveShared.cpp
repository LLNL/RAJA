...
int main(int RAJA_UNUSED_ARG(argc), char **RAJA_UNUSED_ARG(argv[]))
{
  ...
  */
  ...
  using abstractPolicy = RAJA::NestedPolicy<
      RAJA::ExecList<RAJA::cuda_block_y_exec, RAJA::cuda_block_x_exec>>;
#endif
...
void waveShared(T *P1, T *P2, RAJA::RangeSegment outerBounds, double ct, int nx)
{
  ...
  RAJA::forallN<fdNestedPolicy>(
      ...
      outerBounds,
      outerBounds,
      [=](RAJA::Index_type outerIdy, RAJA::Index_type outerIdx) {
      ...
      outerBounds,
      outerBounds,
      [=] __device__(RAJA::Index_type outerIdy, RAJA::Index_type outerIdx) {
        ...
        innerLoop<innerPolicyY, innerPolicyX>(
            innerPolicy{}, By, Bx, [&](int ly, int lx) {
              ...
              if (lx < 2 * sr) {
                ...
                if (ly < 2 * sr) Lu[ly + By][lx + Bx] = P2[nY2 * nx + nX2];
              }

              if (ly < 2 * sr) Lu[ly + By][lx] = P2[nY2 * nx + nX1];
            });
