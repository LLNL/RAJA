...
//----------------------------------------------------------------------------//
  ...
  RAJA::forall<EXEC_POL1>(host_res, arange,
    ...
    RAJA::expt::Name("RAJA Reduce Seq Kernel"),
...
//----------------------------------------------------------------------------//
  ...
  RAJA::forall<EXEC_POL2>(host_res, arange,
    ...
    RAJA::expt::Name("RAJA Reduce OpenMP Kernel"),
    [=](int i,
...
//----------------------------------------------------------------------------//
  ...
  RAJA::forall<EXEC_POL3>(omp_res, arange,
    ...
    RAJA::expt::Name("RAJA Reduce Target OpenMP Kernel"),
    [=](int i,
...
//----------------------------------------------------------------------------//
  ...
  RAJA::forall<EXEC_POL3>(cuda_res, arange,
    RAJA::expt::Name("RAJA Reduce CUDA Kernel"),
...
//----------------------------------------------------------------------------//
  ...
  RAJA::forall<EXEC_POL3>(hip_res, arange,
    ...
    RAJA::expt::Name("RAJA Reduce HIP Kernel"),
    [=] RAJA_DEVICE ( int i,
...
//----------------------------------------------------------------------------//
  ...
  RAJA::forall<EXEC_POL3>(sycl_res, arange,
    ...
    RAJA::expt::Name("RAJA Reduce SYCL Kernel"),
    [=] RAJA_DEVICE ( int i,
