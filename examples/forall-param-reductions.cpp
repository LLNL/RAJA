...
int main(int RAJA_UNUSED_ARG(argc), char** RAJA_UNUSED_ARG(argv[]))
{
  ...
  using VALOPLOC_INT_MIN =
      RAJA::expt::ValLocOp<int, RAJA::Index_type, RAJA::operators::minimum>;
  using VALOPLOC_INT_MAX =
      RAJA::expt::ValLocOp<int, RAJA::Index_type, RAJA::operators::maximum>;
  ...
  std::cout << "\tmin2, loc2 = " << seq_min2 << " , " << seq_minloc2
            << std::endl;
  std::cout << "\tmax2, loc2 = " << seq_max2 << " , " << seq_maxloc2
            << std::endl;
  ...
  std::cout << "\tmin2, loc2 = " << omp_min2 << " , " << omp_minloc2
            << std::endl;
  std::cout << "\tmax2, loc2 = " << omp_max2 << " , " << omp_maxloc2
            << std::endl;
  ...
  std::cout << "\tmin2, loc2 = " << omp_t_min2 << " , " << omp_t_minloc2
            << std::endl;
  std::cout << "\tmax2, loc2 = " << omp_t_max2 << " , " << omp_t_maxloc2
            << std::endl;
  ...
  std::cout << "\tmin2, loc2 = " << cuda_min2 << " , " << cuda_minloc2
            << std::endl;
  std::cout << "\tmax2, loc2 = " << cuda_max2 << " , " << cuda_maxloc2
            << std::endl;
  ...
  std::cout << "\tmin2, loc2 = " << hip_min2 << " , " << hip_minloc2
            << std::endl;
  std::cout << "\tmax2, loc2 = " << hip_max2 << " , " << hip_maxloc2
            << std::endl;
  ...
  std::cout << "\tmin2, loc2 = " << sycl_min2 << " , " << sycl_minloc2
            << std::endl;
  std::cout << "\tmax2, loc2 = " << sycl_max2 << " , " << sycl_maxloc2
            << std::endl;
