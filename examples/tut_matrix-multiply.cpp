...
//----------------------------------------------------------------------------//
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_A, A, N * N * sizeof(double), hipMemcpyHostToDevice);
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_B, B, N * N * sizeof(double), hipMemcpyHostToDevice);
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_C, C, N * N * sizeof(double), hipMemcpyHostToDevice);
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, C, d_C, N * N * sizeof(double), hipMemcpyDeviceToHost);
  checkResult<double>(Cview, N);
//printResult<double>(Cview, N);
