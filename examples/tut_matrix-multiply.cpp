...
// printResult<double>(Cview, N);
  ...
  using EXEC_POL4 =
      RAJA::KernelPolicy<RAJA::statement::CudaKernel<RAJA::statement::For<
          1,
          RAJA::cuda_block_exec,
          RAJA::statement::
              For<0, RAJA::cuda_thread_exec, RAJA::statement::Lambda<0>>>>>;
  ...
  using EXEC_POL5 =
      RAJA::KernelPolicy<RAJA::statement::CudaKernel<RAJA::statement::For<
          1,
          RAJA::cuda_threadblock_exec<CUDA_BLOCK_SIZE>,
          RAJA::statement::For<0,
                               RAJA::cuda_threadblock_exec<CUDA_BLOCK_SIZE>,
                               RAJA::statement::Lambda<0>>>>>;
  ...
  //
  using EXEC_POL6 = RAJA::KernelPolicy<RAJA::statement::For<
      1,
      RAJA::loop_exec,
      RAJA::statement::For<
          0,
  ...
  RAJA::kernel_param<EXEC_POL6>(
      ...
      // lambda 2
      [=](int col, int row, int /* k */, double& dot) { Cview(row, col) = dot; }
...
// printResult<double>(Cview, N);
  ...
  using EXEC_POL8 =
      RAJA::KernelPolicy<RAJA::statement::CudaKernel<RAJA::statement::For<
          1,
          RAJA::cuda_block_exec,  // row
          RAJA::statement::For<
              0,
              RAJA::cuda_thread_exec,      // col
              RAJA::statement::Lambda<0>,  // dot = 0.0
              RAJA::statement::For<2,
                                   RAJA::seq_exec,
  ...
  using EXEC_POL9 =
      RAJA::KernelPolicy<RAJA::statement::CudaKernel<RAJA::statement::For<
          1,
          RAJA::cuda_threadblock_exec<CUDA_BLOCK_SIZE>,  // row
          RAJA::statement::For<
              0,
              RAJA::cuda_threadblock_exec<CUDA_BLOCK_SIZE>,  // col
              RAJA::statement::Lambda<0>,                    // dot = 0.0
              RAJA::statement::For<2,
                                   RAJA::seq_exec,
                                   RAJA::statement::Lambda<1>  // dot += ...
