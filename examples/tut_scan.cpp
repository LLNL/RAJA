...
int main(int RAJA_UNUSED_ARG(argc), char** RAJA_UNUSED_ARG(argv[]))
{
  ...
  RAJA::inclusive_scan<RAJA::seq_exec>(in,
                                       in + N,
                                       out,
  ...
  RAJA::exclusive_scan<RAJA::seq_exec>(in,
                                       in + N,
                                       out,
                                       RAJA::operators::plus<int>{});
  ...
  RAJA::inclusive_scan_inplace<RAJA::seq_exec>(out,
                                               out + N,
  ...
  RAJA::exclusive_scan_inplace<RAJA::seq_exec>(out,
                                               out + N,
  ...
  RAJA::inclusive_scan<RAJA::omp_parallel_for_exec>(
      in, in + N, out, RAJA::operators::plus<int>{});
  ...
  RAJA::exclusive_scan_inplace<RAJA::omp_parallel_for_exec>(
      out, out + N, RAJA::operators::plus<int>{});
