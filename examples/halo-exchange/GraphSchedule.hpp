...
#ifndef RAJA_EXAMPLES_HALOEXCHANGE_GRAPHSCHEDULE_HPP
#define RAJA_EXAMPLES_HALOEXCHANGE_GRAPHSCHEDULE_HPP
...
{
  GraphSchedule(int my_rank)
    : m_my_rank(my_rank)
  { }

  GraphSchedule(const GraphSchedule&) = delete;
  GraphSchedule& operator=(const GraphSchedule&) = delete;
...
#endif // RAJA_EXAMPLES_HALOEXCHANGE_GRAPHSCHEDULE_HPP
