...
int main(int RAJA_UNUSED_ARG(argc), char** RAJA_UNUSED_ARG(argv[]))
{
  ...
  std::cout << "\tpi = " << std::setprecision(prec) << seq_pi.get() / num_bins
            << std::endl;
  ...
  *atomic_pi = 0;
  ...
  std::cout << "\tpi = " << std::setprecision(prec) << (*atomic_pi) / num_bins
            << std::endl;
  ...
  std::cout << "\tpi = " << std::setprecision(prec) << omp_pi.get() / num_bins
            << std::endl;
  ...
  *atomic_pi = 0;
  ...
  std::cout << "\tpi = " << std::setprecision(prec) << cuda_pi.get() / num_bins
            << std::endl;
