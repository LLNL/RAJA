...
class Raja(CMakePackage, CudaPackage):
    ...
    def hostconfig(self, spec, prefix, py_site_pkgs_dir=None):
        ...
        if "+cuda" in spec:
            ...
            cfg.write(cmake_cache_string("CMAKE_CUDA_FLAGS_RELEASE", "-O3"))
            cfg.write(cmake_cache_string("CMAKE_CUDA_FLAGS_RELWITHDEBINFO", "-O3 -g"))
            cfg.write(cmake_cache_string("CMAKE_CUDA_FLAGS_DEBUG", "-O0 -g"))
