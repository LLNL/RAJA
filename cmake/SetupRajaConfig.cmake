...
set(RAJA_ENABLE_ROCM ${ENABLE_ROCM})
...
if(PKG_CONFIG_FOUND)
  ...
  foreach(LIB ${CMAKE_CXX_IMPLICIT_LINK_LIBRARIES} ${PLATFORM_LIBS} ${CUDA_LIBRARIES} ${ROCM_LIBRARIES})
    set(PRIVATE_LIBS "${PRIVATE_LIBS} -l${LIB}")
  endforeach()
  foreach(INCDIR ${INCLUDE_DIRECTORIES} ${CUDA_INCLUDE_DIRS} ${ROCM_INCLUDE_DIRS})
