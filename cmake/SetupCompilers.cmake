...
if (ENABLE_ROCM)
  if (NOT RAJA_HOST_CONFIG_LOADED)
    list(APPEND RAJA_EXTRA_HCC_FLAGS -hc; -amdgpu-target=${HCC_ARCH}; ${CMAKE_CXX_COMPILER})

    set(RAJA_HCC_FLAGS_RELEASE -O2 CACHE STRING "")
    set(RAJA_HCC_FLAGS_DEBUG -g; -G; -O0 CACHE STRING "")
    set(RAJA_HCC_FLAGS_MINSIZEREL -Os CACHE STRING "")
    set(RAJA_HCC_FLAGS_RELWITHDEBINFO -g; -G; -O2 CACHE STRING "")
  ...
  set(RAJA_HCC_FLAGS ${RAJA_EXTRA_HCC_FLAGS} CACHE STRING "")
  set(ROCM_HCC_FLAGS ${RAJA_HCC_FLAGS})
  set(ROCM_HCC_FLAGS_RELEASE ${RAJA_HCC_FLAGS_RELEASE})
  set(ROCM_HCC_FLAGS_DEBUG ${RAJA_HCC_FLAGS_DEBUG})
  set(ROCM_HCC_FLAGS_MINSIZEREL ${RAJA_HCC_FLAGS_MINSIZEREL})
  set(ROCM_HCC_FLAGS_RELWITHDEBINFO ${RAJA_HCC_FLAGS_RELWITHDEBINFO})
endif()
# end RAJA_ENABLE_ROCM section
