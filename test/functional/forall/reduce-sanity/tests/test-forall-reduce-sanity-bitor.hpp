...
#ifndef __TEST_FORALL_REDUCEBITOR_SANITY_HPP__
#define __TEST_FORALL_REDUCEBITOR_SANITY_HPP__
...
void ForallReduceBitOrSanityTest(RAJA::Index_type first, RAJA::Index_type last)
{
...
TYPED_TEST_P(ForallReduceSanityTestBit, ReduceBitOrSanityForall)
{
  ...
  ForallReduceBitOrSanityTest<DATA_TYPE, WORKING_RES, 
