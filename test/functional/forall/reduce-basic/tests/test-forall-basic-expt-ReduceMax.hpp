                                  ...
                                  camp::resources::Resource working_res)
{
  ...
  RAJA::forall<EXEC_POLICY>(seg, 
    ...
    [=] RAJA_HOST_DEVICE(IDX_TYPE idx, DATA_TYPE &_mi, DATA_TYPE &_m) {
      _mi = RAJA_MAX(working_array[idx], _mi);
      _m  = RAJA_MAX(working_array[idx], _m);
  });
  ...
  RAJA::forall<EXEC_POLICY>(seg, 
    RAJA::expt::Reduce<RAJA::operators::maximum>(&max),
    [=] RAJA_HOST_DEVICE(IDX_TYPE idx, DATA_TYPE &_m) {
      _m = RAJA_MAX(working_array[idx] * factor, _m);
  });
