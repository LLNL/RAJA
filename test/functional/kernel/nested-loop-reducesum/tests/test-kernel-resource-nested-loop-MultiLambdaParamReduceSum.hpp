...
#include "nested-loop-MultiLambdaParamReduceSum-impl.hpp"
...
//
//
TYPED_TEST_SUITE_P(KernelNestedLoopMultiLambdaParamReduceSumTest);
template <typename T>
class KernelNestedLoopMultiLambdaParamReduceSumTest : public ::testing::Test {};

TYPED_TEST_P(KernelNestedLoopMultiLambdaParamReduceSumTest, NestedLoopMultiLambdaParamKernel) {
  ...
  using EXEC_POLICY = typename MultiLambdaParamNestedLoopExec<LOOP_TYPE, REDUCE_POL, LOOP_POLS>::type;
...
REGISTER_TYPED_TEST_SUITE_P(KernelNestedLoopMultiLambdaParamReduceSumTest,
