...
#ifndef __TEST_KERNEL_REDUCE_CONDITIONAL_LOOP_SEGMENTS_HPP__
#define __TEST_KERNEL_REDUCE_CONDITIONAL_LOOP_SEGMENTS_HPP__
...
#endif  // __TEST_KERNEL_REDUCE_CONDITIONAL_LOOP_SEGMENTS_HPP__
