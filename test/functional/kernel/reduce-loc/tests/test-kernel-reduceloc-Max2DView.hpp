...
void KernelLocMax2DViewTestImpl(const INDEX_TYPE xdim, const INDEX_TYPE ydim)
{
  ...
  RAJA::kernel<EXEC_POLICY>(RAJA::make_tuple(colrange, rowrange),
                           [=] RAJA_HOST_DEVICE (INDEX_TYPE c, INDEX_TYPE r) {
                             maxloc_reducer.maxloc(ArrView(r, c), Index2D<INDEX_TYPE>(c, r));
                           });
...
TYPED_TEST_P(KernelLocMax2DViewTest, LocMax2DViewKernel)
{
  ...
  KernelLocMax2DViewTestImpl<INDEX_TYPE, DATA_TYPE, WORKING_RES, FORALL_POLICY, EXEC_POLICY, REDUCE_POLICY>(INDEX_TYPE{10}, INDEX_TYPE{10});
  KernelLocMax2DViewTestImpl<INDEX_TYPE, DATA_TYPE, WORKING_RES, FORALL_POLICY, EXEC_POLICY, REDUCE_POLICY>(INDEX_TYPE{151}, INDEX_TYPE{151});
  KernelLocMax2DViewTestImpl<INDEX_TYPE, DATA_TYPE, WORKING_RES, FORALL_POLICY, EXEC_POLICY, REDUCE_POLICY>(INDEX_TYPE{362}, INDEX_TYPE{362});
}
