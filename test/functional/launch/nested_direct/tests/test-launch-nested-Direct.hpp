...
void LaunchNestedDirectTestImpl(INDEX_TYPE M)
{
  ...
  RAJA::TypedRangeSegment<INDEX_TYPE> r4(0, 4*RAJA::stripIndexType(M));
  RAJA::TypedRangeSegment<INDEX_TYPE> r5(0, 5*RAJA::stripIndexType(M));
  RAJA::TypedRangeSegment<INDEX_TYPE> r6(0, 6*RAJA::stripIndexType(M));
  ...
  if ( RAJA::stripIndexType(N) > 0 ) {
    ...
    RAJA::launch<LAUNCH_POLICY>
      (RAJA::LaunchParams(RAJA::Teams(blocks_x, blocks_y, blocks_z), RAJA::Threads(blocks_x, blocks_y ,blocks_z)),
        ...
        RAJA::loop<TEAM_Z_POLICY>(ctx, r3, [&](INDEX_TYPE bz) {
            RAJA::loop<TEAM_Y_POLICY>(ctx, r2, [&](INDEX_TYPE by) {
                RAJA::loop<TEAM_X_POLICY>(ctx, r1, [&](INDEX_TYPE bx) {
