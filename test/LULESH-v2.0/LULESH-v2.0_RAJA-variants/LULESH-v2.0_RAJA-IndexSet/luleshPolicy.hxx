...
typedef RAJA::IndexSet::ExecPolicy<Segment_Iter, RAJA::omp_parallel_for_exec> node_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Segment_Iter, RAJA::omp_parallel_for_exec> elem_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Segment_Iter, RAJA::omp_parallel_for_exec> mat_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Segment_Iter, RAJA::omp_parallel_for_exec> symnode_exec_policy;
...
typedef RAJA::cilk_for_segit         Segment_Iter;
...
typedef RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::cuda_exec>  node_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<RAJA::omp_cuda_taskgraph_segit, RAJA::cuda_exec> elem_exec_policy;
// typedef RAJA::IndexSet::ExecPolicy<RAJA::omp_cuda_taskgraph_segit, RAJA::cuda_exec> mat_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::cuda_exec>  mat_exec_policy;
