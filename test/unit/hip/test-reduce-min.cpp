...
class ReduceMinHIPUnitTest : public ::testing::Test
{
public:
...
double* ReduceMinHIPUnitTest::dvalue = nullptr;
double* ReduceMinHIPUnitTest::d_dvalue = nullptr;

GPU_TEST_F(ReduceMinHIPUnitTest, generic)
{

  double* dvalue = ReduceMinHIPUnitTest::dvalue;
  double* d_dvalue = ReduceMinHIPUnitTest::d_dvalue;
  reset(dvalue, TEST_VEC_LEN);
...
//
GPU_TEST_F(ReduceMinHIPUnitTest, indexset_align)
{
...
//
GPU_TEST_F(ReduceMinHIPUnitTest, indexset_noalign)
{
