...
CUDA_TYPED_TEST_P(Kernel, Basic)
{
  ...
  auto ranges = RAJA::make_range_tuple(RAJA::TypedRangeSegment<Idx0>(0, x_len),
  ...
  tsum.reset(0.0);
  auto ranges2 =
      RAJA::make_range_tuple(RAJA::TypedRangeSegment<Idx0>(0, stride1),
...
using TestTypes = ::testing::Types<
    list<KernelPolicy<
             ForT<Index_type, s, statement::ForT<TypedIndex, s, Lambda<0>>>>,
...
CUDA_TEST(Kernel, CudaCollapse1a)
{
  using Pol = KernelPolicy<CudaKernel<
      // Collapse<RAJA::cuda_threadblock_exec<128>, ArgList<0,1,2>,
      // Lambda<0>>>>;
      statement::
  ...
  RAJA::kernel<Pol>(RAJA::make_range_tuple(RAJA::RangeSegment(0, 3),
...
CUDA_TEST(Kernel, CudaCollapse1b)
{
  using Pol = RAJA::KernelPolicy<
      CudaKernel<Collapse<RAJA::cuda_threadblock_exec<5>,
                          ArgList<0, 1>,
...
CUDA_TEST(Kernel, CudaCollapse2)
{
  ...
  int N = 41;
  RAJA::kernel<Pol>(RAJA::make_range_tuple(RAJA::RangeSegment(1, N),
                                           RAJA::RangeSegment(1, N)),
                    [=] RAJA_DEVICE(Index_type i, Index_type j) {

                      RAJA::atomic::atomicAdd<RAJA::atomic::cuda_atomic>(sum1,
                                                                         i);
                      RAJA::atomic::atomicAdd<RAJA::atomic::cuda_atomic>(sum2,
                                                                         j);
...
{
  using Pol = RAJA::KernelPolicy<
      CudaKernel<For<0, RAJA::cuda_threadblock_exec<57>, Lambda<0>>>>;
  ...
  RAJA::kernel<Pol>(RAJA::make_range_tuple(RAJA::RangeSegment(0, num_elem)),
                    [=] RAJA_HOST_DEVICE(Index_type i) { ptr[i] = 0.0; });

  RAJA::kernel<Pol>(RAJA::make_range_tuple(RAJA::RangeSegment(first, last)),
...
CUDA_TEST(Kernel, SubRange_Complex)
{
  ...
  using PolB = RAJA::KernelPolicy<
      CudaKernel<Collapse<RAJA::cuda_threadblock_exec<128>,
                          ArgList<0, 1>,
                          For<2, RAJA::seq_exec, Lambda<0>>>>>;
  ...
  RAJA::kernel<PolA>(RAJA::make_range_tuple(RAJA::RangeSegment(0, num_elem)),
                     [=] RAJA_HOST_DEVICE(Index_type i) { ptr[i] = 0.0; });

  RAJA::kernel<PolB>(
      RAJA::make_range_tuple(RAJA::RangeSegment(first, last),
...
TEST(Kernel, Shmem1)
{
  ...
  using Pol = KernelPolicy<
      statement::Tile<0,
                      statement::tile_fixed<TileSize>,
                      seq_exec,
                      SetShmemWindow<For<0, seq_exec, Lambda<0>>,
  ...
  using shmem_t = ShmemTile<seq_shmem,
                            int,
                            ArgList<0>,
                            SizeList<TileSize>,
                            decltype(loop_segments)>;
  shmem_t shmem;
  ...
  kernel_param<Pol>(
      ...
      [=](int i, shmem_t &sh) { sh(i) = i; },
      [=](int i, shmem_t &sh) { x[i] = sh(i) * 2; });
...
TEST(Kernel, FissionFusion)
{
  ...
  kernel<Pol_Fission>(
      ...
      RAJA::make_range_tuple(RangeSegment(0, N), RangeSegment(0, N)),
...
TEST(Kernel, Collapse2)
{
  ...
  RAJA::kernel<Pol>(RAJA::make_range_tuple(RAJA::RangeSegment(0, N),
...
TEST(Kernel, Collapse3)
{
  ...
  RAJA::kernel<Pol>(RAJA::make_range_tuple(RAJA::RangeSegment(0, K),
                                           RAJA::RangeSegment(0, M),
...
TEST(Kernel, Collapse7)
{
  ...
  RAJA::kernel<Pol>(
      RAJA::make_range_tuple(RAJA::RangeSegment(0, K),
                             RAJA::RangeSegment(0, M),
                             RAJA::RangeSegment(0, N),
...
CUDA_TEST(Kernel, CudaExec)
{
  ...
  kernel<Pol>(
      ...
      RAJA::make_range_tuple(RangeSegment(0, N)),
...
CUDA_TEST(Kernel, CudaConditional)
{
  ...
  // Loop Fusion
  using Pol = KernelPolicy<CudaKernel<
      For<0, cuda_threadblock_exec<32>, If<Param<0>, Lambda<0>>, Lambda<1>>>>;
  ...
  for (int param = 0; param < 2; ++param) {
    ...
    kernel_param<Pol>(
        ...
        RAJA::make_range_tuple(TypedRangeSegment<int>(0, N)),
...
CUDA_TEST(Kernel, CudaExec1ac)
{
  ...
  // Loop Fusion
  using Pol =
      KernelPolicy<CudaKernel<statement::Collapse<cuda_threadblock_exec<1024>,
                                                  ArgList<0, 1, 2>,
                                                  Lambda<0>>>>;
...
CUDA_TEST(Kernel, CudaComplexNested)
{
  ...
  auto segments = RAJA::make_range_tuple(RangeSegment(0, N),
                                         RangeSegment(0, N),
                                         RangeSegment(0, N));
...
CUDA_TEST(Kernel, CudaShmemWindow1d)
{
  ...
  using Pol = KernelPolicy<CudaKernel<
      statement::Tile<0,
                      statement::tile_fixed<16>,
                      seq_exec,
                      SetShmemWindow<For<0, cuda_thread_exec, Lambda<0>>,
                                     CudaSyncThreads,
...
CUDA_TEST(Kernel, CudaShmemWindow2d)
{
  ...
  using Pol = KernelPolicy<
      CudaKernel<statement::Tile<1,
                                 statement::tile_fixed<tile_N>,
                                 seq_exec,
                                 //		For<1, cuda_block_exec,
                                 For<1,
                                     cuda_threadblock_exec<tile_M>,
                                     SetShmemWindow<
  ...
  auto segments =
      RAJA::make_range_tuple(RangeSegment(0, N), RangeSegment(0, M));
  ...
  using shmem_t = ShmemTile<cuda_shmem,
                            double,
                            ArgList<0, 1>,
                            SizeList<tile_N, tile_M>,
                            decltype(segments)>;
  using shmem2_t = ShmemTile<cuda_shmem,
                             double,
                             ArgList<0, 1>,
                             SizeList<tile_N, tile_M>,
                             decltype(segments)>;
...
CUDA_TEST(Kernel, Hyperplane_cuda_2d)
{
  ...
  using Pol =
      RAJA::KernelPolicy<CudaKernel<Hyperplane<0,
...
CUDA_TEST(Kernel, Hyperplane_cuda_2d_negstride)
{
  ...
  RAJA::kernel<Pol>(
      RAJA::make_range_tuple(RAJA::RangeStrideSegment(N - 1, -1, -1),
...
CUDA_TEST(Kernel, Hyperplane_cuda_3d_tiled)
{
  ...
  using Pol = RAJA::KernelPolicy<CudaKernel<RAJA::statement::Tile<
      1,
      RAJA::statement::tile_fixed<13>,
      seq_exec,
      RAJA::statement::Tile<2,
                            RAJA::statement::tile_fixed<5>,
                            seq_exec,
                            Hyperplane<0,
                                       cuda_seq_syncthreads_exec,
                                       ArgList<1, 2>,
  ...
  RAJA::kernel<Pol>(
      RAJA::make_range_tuple(RAJA::TypedRangeStrideSegment<ZoneI>(0, N, 1),
...
TEST(Kernel, IndexCalc_seq)
{
  ...
  auto segments = RAJA::make_range_tuple(RAJA::RangeSegment(0, N));
  using segment_t = decltype(segments);

  using loop_data_t =
      RAJA::internal::LoopData<RAJA::list<>, segment_t, RAJA::tuple<>>;
