                              ...
                              Index_type alen)
{
  ...
  forall<POLICY_T>(0, alen, [=] __host__ __device__ (int i) {
                          ...
                          Index_type alen)
{
  ...
  runBasicMinMaxAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                          ...
                          Index_type alen)
{
  ...
  runBasicAddSubAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                          ...
                          Index_type alen)
{
  ...
  runBasicAndOrXorAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                          ...
                          Index_type alen)
{
  ...
  runBasicIncDecAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                          ...
                          Index_type alen)
{
  ...
  runBasicCompExchAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                              ...
                              Index_type)
{
  ...
  forall<POLICY_T>(0, (int)n, [=] __host__ __device__ (int i) {
                          ...
                          Index_type alen)
{
  ...
  runBasicLoadExchAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                          ...
                          Index_type alen)
{
  ...
  runBasicLoadStoreAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
                              ...
                              Index_type alen)
{
  ...
  int* ivalue;
  cudaMallocManaged(&ivalue, sizeof(int)*alen);
                          ...
                          Index_type alen)
{
  ...
  runBasicCountingAtomicTest<cuda_exec<block_size>,
                           cuda_atomic>(
      "cuda_exec", in_array, alen);
...
int main(int RAJA_UNUSED_ARG(argc), char** RAJA_UNUSED_ARG(argv))
{
  ...
  cudaMallocManaged((void**)&ivalue_check,
                    array_length * sizeof(Index_type));
