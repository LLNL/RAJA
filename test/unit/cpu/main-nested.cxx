...
struct Pol2dA {
  ...
  typedef RAJA::View<RAJA::Index_type, PermutedLayout<PERM_IJ>> VIEW;
};
...
struct Pol2dB {
  ...
  typedef RAJA::View<RAJA::Index_type, PermutedLayout<PERM_JI>> VIEW;
};
...
struct PolLTimesA {
  ...
  typedef RAJA::TypedView<double, PermutedLayout<PERM_IJK>, IDirection, IGroup, IZone>
      PSI_VIEW;

  // phi[moment, group, zone]
  typedef RAJA::TypedView<double, PermutedLayout<PERM_IJK>, IMoment, IGroup, IZone>
      PHI_VIEW;

  // ell[moment, direction]
  typedef RAJA::TypedView<double, PermutedLayout<PERM_IJ>, IMoment, IDirection>
      ELL_VIEW;
};
...
struct PolLTimesB {
  ...
  // psi[direction, group, zone]
  typedef RAJA::TypedView<double, PermutedLayout<PERM_KJI>, IDirection, IGroup, IZone>
      PSI_VIEW;
  ...
  // ell[moment, direction]
  typedef RAJA::TypedView<double, PermutedLayout<PERM_JI>, IMoment, IDirection>
      ELL_VIEW;
};
...
struct PolLTimesC {
  ...
  // phi[moment, group, zone]
  typedef RAJA::TypedView<double, PermutedLayout<PERM_KJI>, IMoment, IGroup, IZone>
      PHI_VIEW;
