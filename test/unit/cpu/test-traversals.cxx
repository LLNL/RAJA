...
class TraversalTest : public ::testing::Test {
  protected:
    virtual void SetUp() {
      array_length = buildIndexSet(index_sets_, static_cast<IndexSetBuildMethod>(0));
      array_length += 1;

      RAJA::getIndices(is_indices, index_sets_[0]);

      posix_memalign((void **)&test_array, RAJA::DATA_ALIGN, array_length*sizeof(RAJA::Real_type)) ;
      posix_memalign((void **)&ref_array, RAJA::DATA_ALIGN, array_length*sizeof(RAJA::Real_type)) ;
      posix_memalign((void **)&in_array, RAJA::DATA_ALIGN, array_length*sizeof(RAJA::Real_type)) ;
...
TYPED_TEST_P(TraversalTest, BasicForall) {
  RAJA::forall< TypeParam >( this->index_sets_[0], [=] (RAJA::Index_type idx) {
   ...
   for (int i = 0; i < this->array_length; ++i) {
       EXPECT_EQ(this->ref_array[i], this->test_array[i]) << "Arrays differ at index " << i;
   }
}
...
typedef ::testing::Types<RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::seq_exec>,
                         RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::simd_exec> > SequentialTypes; 

INSTANTIATE_TYPED_TEST_CASE_P(Sequential, TraversalTest, SequentialTypes);


#if defined(RAJA_ENABLE_OPENMP)
typedef ::testing::Types<RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::omp_parallel_for_exec>,
                         RAJA::IndexSet::ExecPolicy<RAJA::omp_parallel_for_segit, RAJA::seq_exec>,
                         RAJA::IndexSet::ExecPolicy<RAJA::omp_parallel_for_segit, RAJA::simd_exec> > OpenMPTypes;

INSTANTIATE_TYPED_TEST_CASE_P(OpenMP, TraversalTest, OpenMPTypes);
#endif
 
#if defined(RAJA_ENABLE_CILK)
typedef ::testing::Types<RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::cilk_for_exec>,
                         RAJA::IndexSet::ExecPolicy<RAJA::cilk_for_segit, RAJA::seq_exec>
                         RAJA::IndexSet::ExecPolicy<RAJA::cilk_for_segit, RAJA::simd_exec> > CilkTypes;
