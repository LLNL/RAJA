...
struct ForallROCM : ::testing::Test {
  virtual void SetUp()
  {
    ...
    rocmMallocManaged((void **)&test_array,
                      sizeof(Real_type) * max_size,
                      0);
    rocmMemset(test_array, 0, sizeof(Real_type) * max_size);

    rocmMallocManaged((void **)&ref_array,
                      sizeof(Real_type) * max_size,
                      0);
    rocmMemset(ref_array, 0, sizeof(Real_type) * max_size);
  }

  virtual void TearDown()
  {
    rocmDeviceFree(::test_array);
    rocmDeviceFree(::ref_array);
    rocmDeviceFree(::parent);
    ::iset = UnitIndexSet();
...
///
ROCM_TEST_F(ForallROCM, forall_range)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;

  rocmMemset(test_array, 0, sizeof(RAJA::Real_type) * array_length);
  rocmMemset(ref_array, 0, sizeof(RAJA::Real_type) * array_length);
...
///
ROCM_TEST_F(ForallROCM, forall_icount_range)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;
...
///
ROCM_TEST_F(ForallROCM, forall_indexset)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;
...
///
ROCM_TEST_F(ForallROCM, forall_icount_indexset)
{
  RAJA::Real_ptr parent = ::parent;
  RAJA::Real_ptr test_array = ::test_array;
  RAJA::Real_ptr ref_array = ::ref_array;
