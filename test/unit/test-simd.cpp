...
TEST(SIMD, OMPAndSimd_MultiLambda){
    ...
    double *a2 = RAJA::allocate_aligned_type<double>(RAJA::DATA_ALIGN, N*M*sizeof(double));
    double *b2 = RAJA::allocate_aligned_type<double>(RAJA::DATA_ALIGN, N*M*sizeof(double));
    double *c2 = RAJA::allocate_aligned_type<double>(RAJA::DATA_ALIGN, N*M*sizeof(double));
