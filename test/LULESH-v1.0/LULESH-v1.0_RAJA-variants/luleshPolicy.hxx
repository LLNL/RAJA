...
typedef RAJA::IndexSet::ExecPolicy<Hybrid_Seg_Iter, Segment_Exec>
    node_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Hybrid_Seg_Iter, Segment_Exec>
    elem_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Hybrid_Seg_Iter, Segment_Exec>
...
// and that block decomposition is the indexset used for the first touch (see
// CreateMaskedIndexSet)
...
typedef RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::omp_parallel_for_exec>
    node_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<RAJA::omp_parallel_for_segit,
                                   RAJA::simd_exec> elem_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<RAJA::omp_parallel_for_segit,
                                   RAJA::simd_exec> mat_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<RAJA::seq_segit, RAJA::omp_parallel_for_exec>
    symnode_exec_policy;
...
// Can be used with or without OMP_FINE_SYNC; without will have less data
// movement and memory use

// AllocateTouch should definitely be used

// In reality, only the "lock-free" operations need to use the dependence graph
// embedded in the
// lock-free indexset, and the dependence-graph should likely be deactivated for
// other operations.
...
typedef RAJA::IndexSet::ExecPolicy<Hybrid_Seg_Iter, RAJA::omp_parallel_for_exec>
    node_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Hybrid_Seg_Iter, RAJA::omp_parallel_for_exec>
    elem_exec_policy;
typedef RAJA::IndexSet::ExecPolicy<Hybrid_Seg_Iter, RAJA::omp_parallel_for_exec>
