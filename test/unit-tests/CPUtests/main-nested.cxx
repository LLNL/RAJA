...
void run2dTest(std::string const &policy,
               Index_type size_i,
               Index_type size_j) {
...
struct Pol2dB_OMP {
  typedef NestedPolicy<ExecList<simd_exec, omp_for_nowait_exec>,
                       OMP_Parallel<Permute<PERM_JI>>> EXEC;
...
struct PolLTimesD_OMP {
  ...
  typedef NestedPolicy<ExecList<seq_exec,
                                ...
                                seq_exec,
                                omp_for_nowait_exec>,
                       OMP_Parallel<Permute<PERM_LKIJ>>> EXEC;
