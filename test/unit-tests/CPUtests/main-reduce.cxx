  ...
  for (int k = 1; k <= loops; ++k) {
    ...
    if (Real_type(tmin0) != Real_type(k * ref_min_val)
      ...
      cout << "\ttmin0 = " << Real_type(tmin0) << " (" << k * ref_min_val
           << ") " << endl;
      cout << "\ttmin1 = " << Real_type(tmin1) << " (" << -200.0 << ") "
           << endl;
    } else {
      s_ntests_passed++;
  ...
  for (int k = 1; k <= loops; ++k) {
    ...
    if (Real_type(tmin0) != Real_type(k * ref_min_val)
      ...
      cout << "\ttmin0, loc = " << Real_type(tmin0) << " , "
           ...
           << ref_min_indx << " ) " << endl;
      cout << "\ttmin1, loc = " << Real_type(tmin1) << " , "
           << tmin1.getMinLoc() << " (" << -200.0 << ", " << -1 << " ) "
           << endl;
    } else {
      s_ntests_passed++;
      s_ntests_passed_total++;
  ...
  for (int k = 1; k <= loops; ++k) {
    ...
    if (Real_type(tmax0) != Real_type(k * ref_max_val)
      ...
      cout << "\ttmax0 = " << Real_type(tmax0) << " (" << k * ref_max_val
           << ") " << endl;
      cout << "\ttmax1 = " << Real_type(tmax1) << " (" << 200.0 << ") " << endl;
    } else {
      s_ntests_passed++;
      s_ntests_passed_total++;
    }
  ...
  for (int k = 1; k <= loops; ++k) {
    ...
    if (Real_type(tmax0) != Real_type(k * ref_max_val)
      ...
      cout << "\ttmax0, loc = " << Real_type(tmax0) << " , "
           ...
           << ref_max_indx << " ) " << endl;
      cout << "\ttmax1, loc = " << Real_type(tmax1) << " , "
           << tmax1.getMaxLoc() << " (" << 200.0 << ", " << -1 << " ) " << endl;
    } else {
      s_ntests_passed++;
      s_ntests_passed_total++;
    }
