...
struct DLayout : public RAJA::Layout<IdxLin, Perm, Idxs...> {
  ...
  RAJA_HOST_DEVICE inline DLayout(ARGS... args)
...
struct DView<DataType, DLayout<IdxLin, Perm, Idxs...>>
    : public RAJA::View<DataType, DLayout<IdxLin, Perm, Idxs...>> {
...
RAJA_INLINE void dForallN(Grid_Data &domain, int sdom_id, BODY const &body) {
  RAJA::RangeSegment seg_i = domain.indexRange<IdxI>(sdom_id);
