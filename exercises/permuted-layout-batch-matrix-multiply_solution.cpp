...
//----------------------------------------------------------------------------//
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_A, A, N_c * N_r * N * sizeof(double), hipMemcpyHostToDevice);
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_B, B, N_c * N_r * N * sizeof(double), hipMemcpyHostToDevice);
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_A2, A2, N_c * N_r * N * sizeof(double), hipMemcpyHostToDevice);
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_B2, B2, N_c * N_r * N * sizeof(double), hipMemcpyHostToDevice);
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, C, d_C, N_c * N_r * N * sizeof(double), hipMemcpyDeviceToHost);
...
//----------------------------------------------------------------------------//
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, C2, d_C2, N_c * N_r * N * sizeof(double), hipMemcpyDeviceToHost);
