...
// _3D_raja_deviceview_end
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, d_a, a, N_tot * sizeof(double), hipMemcpyHostToDevice);
...
// _raja_tensorinit_hip_end
  ...
  RAJA_INTERNAL_HIP_CHECK_API_CALL(hipMemcpy, a, d_a, N_tot * sizeof(double), hipMemcpyDeviceToHost);
  checkResult(a, a_ref, N_tot);
