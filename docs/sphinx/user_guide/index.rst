...
as a variety of loop transformations, reductions, scans, sorts, atomic
operations, data layouts and views, iteration spaces, etc. Currently
available execution patterns supported by different programming model
back-ends include:
sequential,
