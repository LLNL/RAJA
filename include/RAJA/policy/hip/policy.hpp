...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_THREAD_POLICIES(flatten, mapping)      \
  ...
  using hip_##flatten##thread_##mapping =                                      \
      hip_##flatten##indexer_##mapping<hip::IndexGlobal<                       \
...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_BLOCK_POLICIES(flatten, mapping)       \
  template<named_dim... dims>                                                  \
  using hip_##flatten##block_##mapping =                                       \
      hip_##flatten##indexer_##mapping<hip::IndexGlobal<                       \
...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_GLOBAL_POLICIES(flatten, mapping)      \
  template<named_dim... dims>                                                  \
  using hip_##flatten##global_##mapping =                                      \
      hip_##flatten##indexer_##mapping<hip::IndexGlobal<                       \
...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_ONE_SIZE_POLICIES_HELPER(              \
...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_TWO_SIZE_POLICIES_HELPER(              \
    flatten, scope, mapping)                                                   \
...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_THREAD_SIZE_POLICIES(flatten, mapping) \
  RAJA_INTERNAL_HIP_ALIAS_INDEXER_ONE_SIZE_POLICIES_HELPER(flatten, thread,    \
                                                           mapping)
...
#define RAJA_INTERNAL_HIP_ALIAS_INDEXER_BLOCK_SIZE_POLICIES(flatten, mapping)  \
  RAJA_INTERNAL_HIP_ALIAS_INDEXER_ONE_SIZE_POLICIES_HELPER(flatten, block,     \
                                                           mapping)
