...
*/
template <typename Indexer, bool Async, typename Iter, typename Compare>
...
*/
template <typename Indexer, bool Async, typename Iter>
concepts::enable_if_t<resources::EventProxy<resources::Hip>,
                      type_traits::is_arithmetic<RAJA::detail::IterVal<Iter>>,
                      std::is_pointer<Iter>>
stable(
...
unstable(
    resources::Hip hip_res,
    ::RAJA::policy::hip::hip_exec<Indexer, Async> p,
    Iter begin,
    Iter end,
