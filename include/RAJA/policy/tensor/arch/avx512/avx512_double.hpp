...
namespace RAJA
{
  ...
  class TensorRegister<avx512_register, double, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>, SKEW> :
    public internal::TensorRegisterBase<TensorRegister<avx512_register, double, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>, SKEW>>
  {
    public:
      using register_policy = avx512_register;
      using self_type = TensorRegister<avx512_register, double, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>, SKEW>;
