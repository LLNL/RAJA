...
namespace RAJA
{
  ...
  template<>
  class TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>> :
    public internal::VectorRegisterBase<TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>>>
  {
    public:
      using register_policy = avx2_register;
      using self_type = TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>>;
