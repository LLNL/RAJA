...
namespace RAJA
{
  ...
  template<>
  class TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>> :
    public internal::VectorRegisterBase<TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>>>
  {
    public:
      using register_policy = avx2_register;
      using self_type = TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>>;
      using element_type = int;
      using register_type = __m256i;

      using int_vector_type = TensorRegister<avx2_register, int, VectorLayout, camp::idx_seq<8>>;
