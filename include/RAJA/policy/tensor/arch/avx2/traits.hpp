...
namespace internal {
  ...
  template<>
  struct RegisterTraits<avx2_register, int32_t>{
  ...
  template<>
  struct RegisterTraits<avx2_register, int64_t>{
  ...
  template<>
  struct RegisterTraits<avx2_register, float>{
  ...
  template<>
  struct RegisterTraits<avx2_register, double>{
