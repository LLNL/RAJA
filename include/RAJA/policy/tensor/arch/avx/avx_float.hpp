...
namespace RAJA
{
  ...
  template<>
  class TensorRegister<avx_register, float, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>> :
    public internal::VectorRegisterBase<TensorRegister<avx_register, float, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>>>
  {
    public:
      using register_policy = avx_register;
      using self_type = TensorRegister<avx_register, float, VectorLayout, camp::idx_seq<8>, camp::idx_seq<0,1,2,3,4,5,6,7>>;
