...
namespace RAJA
{
  ...
  template<size_t N>
  class Register<vector_altivec_register, int, N>:
    public internal::RegisterBase<Register<vector_altivec_register, int, N>>
  {
    ...
    public:
      using self_type = Register<vector_altivec_register, int, N>;
