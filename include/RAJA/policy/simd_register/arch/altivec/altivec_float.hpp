...
namespace RAJA
{
  ...
  template<>
  class Register<altivec_register, float>:
    public internal::RegisterBase<Register<altivec_register, float>>
  {
    public:
      using register_policy = altivec_register;
      using self_type = Register<altivec_register, float>;
    ...
    public:
       ...
       */
      RAJA_INLINE
      Register() : m_value{element_type(0), element_type(0), element_type(0), element_type(0)} {
      }
