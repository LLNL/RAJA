...
#ifndef RAJA_policy_vector_register_avx2_double1_HPP
#define RAJA_policy_vector_register_avx2_double1_HPP
...
namespace RAJA
{
  ...
  template<>
  class Register<vector_avx2_register, double, 1> :
    public internal::RegisterBase<Register<vector_avx2_register, double, 1>>
  {
    public:
      using self_type = Register<vector_avx2_register, double, 1>;
