...
#ifndef RAJA_policy_vector_register_altivec_int64_HPP
#define RAJA_policy_vector_register_altivec_int64_HPP
...
namespace RAJA
{
    ...
    public internal::RegisterBase<Register<altivec_register, long>>
  {
    ...
    private:
      vector signed long long m_value;
