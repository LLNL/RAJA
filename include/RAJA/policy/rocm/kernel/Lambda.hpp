...
#ifndef RAJA_policy_rocm_kernel_Lambda_HPP
#define RAJA_policy_rocm_kernel_Lambda_HPP
...
struct ROCmStatementExecutor<Data, statement::Lambda<LoopIndex>, IndexCalc> {
