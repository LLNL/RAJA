 ...
 * \file
 *
 * \brief   Header file for ROCM hyperplane executors.
 *
 ******************************************************************************
 */
...
#ifndef RAJA_policy_rocm_kernel_Hyperplane_HPP
#define RAJA_policy_rocm_kernel_Hyperplane_HPP
...
struct ROCmStatementExecutor<Data,
  ...
  using index_calc_t = ROCmIndexCalc_Terminator<typename Data::segment_tuple_t>;
