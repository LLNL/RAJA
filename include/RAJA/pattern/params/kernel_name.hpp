...
#define RAJA_KERNEL_NAME RAJA::expt::detail::defaultKernelName(__func__, __FILE__, __LINE__)
                                     ...
                                     const int line_number)
{
   ...
   defaultName += std::string(func_name) +  " " + std::string(strrchr(file_name, '/')) + ":L" + std::to_string(line_number);
