...
#ifndef RAJA_pattern_nested_Hyperplane_HPP
...
/*!
 * A nested::forall statement that performs hyperplane iteration over multiple
 * indices.
 *
 ...
 *
 *     RAJA::nested::forall<Collapse<ExecPolicy, ArgList<1,2,...>, Lambda<0>>>(
