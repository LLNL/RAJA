 ...
 * \file
 *
 * \brief   RAJA header file defining list segment class.
 *
 ******************************************************************************
 */
...
#ifndef RAJA_NewListSegment_HPP
#define RAJA_NewListSegment_HPP
...
/*
 * The following two ctors preserve the old list segment behavior for
 ...
 */
  ...
  ///
  NewTypedListSegment(const NewTypedListSegment& other)
  ...
  ///
  NewTypedListSegment(NewTypedListSegment&& rhs)
  ...
  ///
  RAJA_HOST_DEVICE void swap(NewTypedListSegment& other)
  {
  ...
  //! accessor to get the end iterator for a NewTypedListSegment
  RAJA_HOST_DEVICE iterator end() const { return m_data + m_size; }

  //! accessor to get the begin iterator for a NewTypedListSegment
  RAJA_HOST_DEVICE iterator begin() const { return m_data; }

  //! accessor to retrieve the total number of elements in a NewTypedListSegment
  ...
  ///
  RAJA_HOST_DEVICE bool operator==(const NewTypedListSegment& other) const
  {
...
/*!
 *  Specialization of std::swap for NewTypedListSegment
 */
template <typename T>
RAJA_INLINE void swap(RAJA::NewTypedListSegment<T>& a,
                      RAJA::NewTypedListSegment<T>& b)
{
  a.swap(b);
}
}  // namespace std
