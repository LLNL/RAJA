...
template<camp::idx_t I, bool is_val, typename... Ts>
RAJA_HOST_DEVICE RAJA_INLINE constexpr RAJA::zip_tuple_element_t<I,
                                                     zip_tuple<is_val, Ts...>>&
...
RAJA_HOST_DEVICE RAJA_INLINE constexpr void zip_for_each_impl(Tuple&& t,
                                               F&& f,
                                               camp::idx_seq<Is...>)
{
...
RAJA_HOST_DEVICE RAJA_INLINE constexpr void zip_for_each_impl(Tuple0&& t0,
                                               Tuple1&& t1,
                                               F&& f,
                                               camp::idx_seq<Is...>)
{
...
RAJA_HOST_DEVICE RAJA_INLINE constexpr void zip_for_each(Tuple0&& t0, Tuple1&& t1, F&& f)
{
...
struct zip_tuple
{
  ...
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple(zip_tuple& o) : zip_tuple(o, IdxSeq {})
  {}
  ...
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& operator=(zip_tuple const& o)
  {
    return assign_helper(o, IdxSeq {});
  }
  ...
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple(opp_tuple& o) : zip_tuple(o, IdxSeq {})
  {}
  ...
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& operator=(opp_tuple const& o)
  {
    return assign_helper(o, IdxSeq {});
  }
  ...
  template<camp::idx_t I>
  RAJA_HOST_DEVICE RAJA_INLINE constexpr RAJA::tuple_element_t<I, value_type> const& get()
      const& noexcept
  {
    return RAJA::get<I>(m_tuple);
  }
...
private:
  ...
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& assign_helper(camp::idx_seq<Is...>, Os&&... os)
  {
  ...
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple(zip_tuple& o, camp::idx_seq<Is...>)
  ...
  template<camp::idx_t... Is>
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& assign_helper(zip_tuple& o,
                                                        camp::idx_seq<Is...>)
  {
    if (this != &o)
    {
  ...
  template<camp::idx_t... Is>
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& assign_helper(zip_tuple const& o,
                                                        camp::idx_seq<Is...>)
  {
    if (this != &o)
    {
  ...
  template<camp::idx_t... Is>
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple(opp_tuple& o, camp::idx_seq<Is...>)
      : zip_tuple(RAJA::get<Is>(o)...)
  {}
  ...
  template<camp::idx_t... Is>
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& assign_helper(opp_tuple& o,
                                                        camp::idx_seq<Is...>)
  {
    camp::sink(get<Is>() = RAJA::get<Is>(o)...);
    return *this;
  ...
  template<camp::idx_t... Is>
  RAJA_HOST_DEVICE RAJA_INLINE constexpr zip_tuple& assign_helper(opp_tuple const& o,
                                                        camp::idx_seq<Is...>)
  {
    camp::sink(get<Is>() = RAJA::get<Is>(o)...);
    return *this;
